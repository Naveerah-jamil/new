...
const Cart = () => {
  return (
    <div className="w-full min-h-screen flex flex-col bg-white px-4 sm:px-6 lg:px-8">
      {/* Main Content */}
      <p className="font-[Inter] font-medium text-[22px] sm:text-[24px] lg:text-[28px] leading-[33px] sm:leading-[36px] text-center lg:text-left pl-[190px] pt-[20px]">
        Bag
      </p>
      <main className="container mx-auto flex flex-col lg:flex-row mt-8 gap-6">
        ...
        <div className="bg-white flex flex-col w-full lg:w-7/12 rounded-lg p-4 sm:p-6">
          <div className="flex flex-col space-y-6 pl-[150px]">
            {/* Cart Item 1 */}
